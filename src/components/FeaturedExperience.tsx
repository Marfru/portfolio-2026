                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2">
                      <a
                        ...
                        className="text-lg text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 transition-colors"
                        onClick={(e) => e.stopPropagation()}
                      >
                        {exp.company}
                      </a>
                      {!exp.endDate && (
                        <span className="flex items-center gap-1.5 px-3 py-1 text-xs font-medium bg-green-50 dark:bg-green-900/30 text-gray-900 dark:text-white rounded-full">
