  ...
  return (
    <section className="py-12">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2 text-left">
          Current Tech Stack
        </h2>
        <p className="text-base text-gray-600 dark:text-gray-400 mb-8 text-left">
            ...
            <div className="flex gap-8 animate-scroll">
              {[...Array(2)].map((_, setIndex) =>
                firstRow.map((tech, index) => (
                  ...
                  >
                    <div
                      className={`w-16 h-16 rounded-lg ${tech.color} border border-gray-300/50 dark:border-gray-700/50 flex items-center justify-center p-2 shadow-sm`}
                    >
                      {tech.type === "svg" ? (
                        tech.svg
                      ) : (
                        <span
                          className={`text-2xl font-bold ${tech.textColor}`}
                        >
