export const projects = [
  {
    ...
    tags: ["Beta","NextJS", "Typescript", "Tailwind", "Supabase"],
    ...
    is_live: true,
    description:
      "Picked up an old project from around 2014 and updated it to the latest standards. You can check the old project at old.coloreshtml.com for comparison.",
  ...
  },
  {
    ...
    is_live: true,
    description:
      "Basic Tesla interactive performance calculator landing page, built using Vanilla JS, Intersections and Mutations, SCSS, Webpack.",
